...
import { Loader2, ArrowRight, Gift, Store, Building2 } from 'lucide-react'
  ...
  return (
    <div className="flex min-h-screen flex-col bg-flow-aurora px-6 pt-16">
      <div className="mx-auto w-full max-w-sm">
        <h1 className="mb-3 text-3xl font-bold leading-tight tracking-tight text-foreground">{title}</h1>
        <Gift className="mb-3 h-6 w-6 text-secondary" />
